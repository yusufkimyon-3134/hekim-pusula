...
function toClinicStats(row: ClinicStatsRow): ClinicStats {
  return {
    ...
    avgIncentiveScore: row.avg_incentive_score ?? null,
    avgColleagueScore: row.avg_colleague_score ?? null,
    avgManagementScore: row.avg_management_score ?? null,
    avgCityScore: row.avg_city_score ?? null,
    avgEducationScore: row.avg_education_score ?? null,
    avgAcademicScore: row.avg_academic_score ?? null,
    avgMonthlyShifts: row.avg_monthly_shifts ?? null,
    avgDailyPatients: row.avg_daily_patients ?? null,
    avgServicePatients: row.avg_service_patients ?? null,
    recommendPercentage: row.recommend_percentage ?? null,
...
function toClinicRanking(row: RankClinicsRow): ClinicRanking {
  return {
    ...
    avgAcademicScore: row.avg_academic_score ?? null,
    avgMonthlyShifts: row.avg_monthly_shifts ?? null,
    avgWorkload: row.avg_workload ?? null,
    recommendPercentage: row.recommend_percentage ?? null,
  };
}
